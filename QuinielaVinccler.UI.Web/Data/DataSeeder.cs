...
public static class DataSeeder
{
    ...
    private static async Task SeedPartidosAsync(AppDbContext db)
    {
        ...
        // Orden round-robin estándar: (T1vT2)(T3vT4) (T1vT3)(T2vT4) (T1vT4)(T2vT3)
        var grupos = new[]
        {
        ...
        // Pares round-robin para 4 equipos
        ...
        // ── Eliminatoria: partidos 73-104 ────────────────────────────────────
        // Slots basados en el ANVERSO de la planilla física.
        // ⚠ Verificar numeración exacta contra la planilla impresa.
        var knockout = new[]
        {
            // R32 (73-88)
            ...
            // R16 (89-96)
            (89,  Fase.RoundOf16,   "G73",  "G75",   new DateTime(2026, 7, 10, 18, 0, 0, DateTimeKind.Utc)),
            (90,  Fase.RoundOf16,   "G74",  "G76",   new DateTime(2026, 7, 10, 21, 0, 0, DateTimeKind.Utc)),
